...
@RestController
@RequestMapping("/api/alpha-kafka")
public class AlphaKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AlphaKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private Map<String, SafeKafkaConsumer> consumers = new ConcurrentHashMap<>();

    public AlphaKafkaResource(KafkaProperties kafkaProperties) {
